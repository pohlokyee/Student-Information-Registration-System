    ...
    <table class="table table-hover table-bordered table-striped w-75 p-3" style="background-color: #e3f2fd;">
        ...
        if(mysqli_num_rows($result) > 0){
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<td><a href='update.php?id=".$row['id']."' class='btn btn-success btn-sm'>Edit</a></td>";
                echo "<td><a href='delete_confirmation.php?id=".$row['id']."' class='btn btn-danger btn-sm'>Delete</a></td>";
                echo "</tr>";
            }
        }else{
